...
Generating Discogs API Keys for Testing:

Go to [Discogs API Site](https://www.discogs.com/developers/index.html) and click on "Create an App"
Next, click on "Create Application," enter information (optional) and then Save Changes. 
You should now see some API keys
Create a .env file in the root directory of the project. Populate the file with this information:
...
DISCOGS_TOKEN=[]
"""
where the brackets contain the keys that you generated.
Fill the DISCOGS_TOKEN environment variable with a token generated by clicking "Generate New Token"
You should now be able to run RSpec and Cucumber tests.
---
